...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Yetkili Bilgisi</h4>
                    <p class="mb-1">
                    <p>
                  Sorgulanan kişinin hangi sunucularda yetkili olduğunu görüntüleye bilirsiniz.</br>
                    </p>
                    </p>
    ...
    if (!Array.isArray(json.GuildStaff)) {
        Swal.fire({
            icon: 'error',
            title: "Veri Bulunamadı",
            text: 'Kişinin yetkili olduğu sunucular bulunamadı.',
            background: 'black',
        });
        return;
    }

    json.GuildStaff.forEach(guildData => {
        var row = "<tr>" +
