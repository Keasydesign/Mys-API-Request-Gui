...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Kullanıcı Bilgisi</h4>
                    <p class="mb-1">
                    <p>
                    Sorgulanan kişinin sunucularda kayıtlı isimini ve yaşını görünteleye bilirsiniz.</br>
                    </p>
                    </p>
                    <div class="block-content tab-content">
                        ...
                        <center class="nw">
                            <button onclick="checkNumber()" id="sorgula" name="yolla" class="btn waves-effect waves-light btn-rounded btn-primary" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fas fa-search"></i> Sorgula <span id="cartelfx"></span></button>
    ...
    <script>
        ...
        function clearValues() {
            ...
            document.getElementById("cartelfx").innerHTML = "";
        }
    ...
    $.ajax({
        ...
        success: (res) => {
            ...
            clearResults();
            $("#mysterious").html("");
            document.getElementById("cartelfx").innerHTML = "(" + 1 + ")";
